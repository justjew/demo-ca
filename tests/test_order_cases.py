...
from domain.entities.catalog import ModifierGroup, Product
...
from domain.use_cases.order_cases import ChangeOrderStatusUseCase, CreateOrderUseCase
...
def process_payment_use_case(order_repo_mock, event_dispatcher_mock):
    from domain.interfaces.gateways import IFiscalGateway, IPaymentGateway
